...
impl SwapType {
    pub fn opposite(self) -> Self {
        match self {
            SwapType::BuyAsset { amount_rgb, amount_msats } => SwapType::SellAsset { amount_rgb, amount_msats },
            SwapType::SellAsset { amount_rgb, amount_msats } => SwapType::BuyAsset { amount_rgb, amount_msats },
        }
    }
